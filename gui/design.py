...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "%album (disc %disc)/%track - %artist - %title"))
        ...
        item.setText(_translate("MainWindow", "Albumn"))
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Save files to"))
